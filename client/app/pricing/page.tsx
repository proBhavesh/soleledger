		...
		<div className="mx-auto max-w-7xl p-5">
			<div className="mx-auto text-center max-w-3xl mb-12">
				...
				<p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
					Choose the plan that fits your business needs, with a 30-day
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
				...
				<Card className="flex flex-col relative overflow-hidden hover:shadow-xl transition-all duration-300 group">
					...
					<CardFooter className="pt-6">
						<Button
							className="w-full h-12 text-base cursor-pointer hover:scale-[1.02] transition-transform duration-200 cur"
					...
					<Accordion type="single" collapsible className="w-full">
						<AccordionItem value="credit-card">
							...
							<AccordionContent className="text-muted-foreground leading-relaxed">
								No, your 30-day trial does not require a credit
								card. You can try any plan risk-free.
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem value="trial-end">
							...
							<AccordionContent className="text-muted-foreground leading-relaxed">
								You&apos;ll be prompted to select a plan and
								enter payment details to continue using
								SoleLedger.
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem value="annual-billing">
							...
							<AccordionContent className="text-muted-foreground leading-relaxed">
								Yes, you can save up to 20% by choosing annual
								billing. Contact our support team to switch.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
