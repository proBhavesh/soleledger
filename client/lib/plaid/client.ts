...
const plaidEnv = process.env.PLAID_ENVIRONMENT as keyof typeof PlaidEnvironments || 'sandbox';
...
if (!plaidClientId || !plaidSecret) {
    console.error("ERROR: Missing Plaid credentials. Check your .env file for PLAID_CLIENT_ID and PLAID_SECRET.");
}
...
export const PLAID_REDIRECT_URI = process.env.PLAID_REDIRECT_URI || 'http://localhost:3000/api/plaid/oauth-return'; 